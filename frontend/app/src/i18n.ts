...
const resources = {
  az: {
    translation: {
      ...
      authPlatformName: 'EcoAI Platforması',
      authEnergySystem: 'Enerji İdarəetmə Sistemi',
      authGrid: 'Şəbəkə',
      authBattery: 'Batareya',
      authTagline: 'Ağıllı şəbəkəyə qoşulun, enerji istehlakınızı optimallaşdırın və karbon izini minimuma endirin. Süni intellekt əsaslı gələcək.',
      authRegisterBadge: 'Qeydiyyat',
      authWelcomeBadge: 'Xoş gəlmisiniz',
      authCreateAccount: 'Yeni hesab yaradın',
      authSignInTitle: 'Sistemə daxil olun',
      authFullName: 'Ad Soyad',
      authEmail: 'E-poçt (ID)',
      authPassword: 'Şifrə',
      authNameRequired: 'Ad Soyad daxil edin',
      authConfirmEmail: 'Emailinizi yoxlayın — təsdiq linki göndərildi.',
      authError: 'Xəta baş verdi',
      authLoading: 'Gözləyin...',
      authRegister: 'Qeydiyyat',
      authSignIn: 'Daxil ol',
      authHaveAccount: 'Hesabınız var? Daxil olun',
      authNoAccount: 'Qeydiyyatdan keçin',
      authHome: 'Ana səhifə',
  ...
  en: {
    translation: {
      ...
      authPlatformName: 'EcoAI Platform',
      authEnergySystem: 'Energy Management System',
      authGrid: 'Grid',
      authBattery: 'Battery',
      authTagline: 'Connect to a smarter grid, optimize your energy consumption, and minimize your carbon footprint with an AI-powered future.',
      authRegisterBadge: 'Sign Up',
      authWelcomeBadge: 'Welcome',
  ...
  ru: {
    translation: {
      ...
      authPlatformName: 'Платформа EcoAI',
      authEnergySystem: 'Система управления энергией',
      authGrid: 'Сеть',
      authBattery: 'Батарея',
      authTagline: 'Подключайтесь к умной сети, оптимизируйте энергопотребление и снижайте углеродный след с помощью ИИ.',
      authRegisterBadge: 'Регистрация',
      authWelcomeBadge: 'Добро пожаловать',
      authCreateAccount: 'Создайте аккаунт',
      authSignInTitle: 'Войдите в систему',
      authFullName: 'Полное имя',
      authEmail: 'Эл. почта',
      authPassword: 'Пароль',
      authNameRequired: 'Введите полное имя',
      authConfirmEmail: 'Проверьте почту — ссылка для подтверждения отправлена.',
      authError: 'Произошла ошибка',
      authLoading: 'Подождите...',
      authRegister: 'Зарегистрироваться',
      authSignIn: 'Войти',
      authHaveAccount: 'Уже есть аккаунт? Войдите',
      authNoAccount: 'Создать аккаунт',
      authHome: 'Главная',
